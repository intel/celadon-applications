...
public class MultiViewActivity extends AppCompatActivity {
    ...
    private ImageButton mTopLeftCam_RecordButton, mTopLeftCam_PictureButton, mTopLeftCam_Switch, mTopLeftCam_Split,
            mTopRightCam_PictureButton, mTopRightCam_RecordButton, mTopRightCam_Switch, mTopRightCam_Split,
            mBotmLeftCam_PictureButton, mBotmLeftCam_RecordButton, mBotmLeftCam_Switch, mBotmLeftCam_Split,
            mBotmRightCam_PictureButton, mBotmRightCam_RecordButton, mBotRightCam_Switch, mBotRightCam_Split;
    ...
    public void GetCameraCnt() {
        ...
        try {
            ...
            if(numOfCameras == 0) {
                Toast.makeText(MultiViewActivity.this, "No camera found closing the application", Toast.LENGTH_LONG).show();
            }
    ...
    public void Open_TopRightCam() {
        ...
        ic_camera.setTopRightCam(new CameraBase(this, mTopRightCam_textureView, Buttons, mRecordingTimeView0,
                                      Data, roundedThumbnailView));
    }
    ...
    public void Open_BotmLeftCam() {
        ...
        ic_camera.setBotLeftCam(new CameraBase(this, mBotmLeftCam_textureView, Buttons, mRecordingTimeView1,
                                      Data, roundedThumbnailView));
    }
    ...
    private void manageTopLeftCam() {
        ...
        if (mTopLeftCam_textureView.isAvailable()) {
            ...
            if (ic_camera.getTopLeftCam() != null && mTopLeftCam_textureView != null) {
                mTopLeftCam_textureView.setSurfaceTextureListener(ic_camera.getTopLeftCam().textureListener);
            }
        }
    ...
    private void manageTopRightCam() {
        ...
        if (mTopRightCam_textureView.isAvailable()) {
            ...
            mTopRightCam_textureView.setSurfaceTextureListener(ic_camera.getTopRightCam().textureListener);
        }
    }
    ...
    private void manageBotmLeftCam() {
        ...
        if (mBotmLeftCam_textureView.isAvailable()) {
            ...
            mBotmLeftCam_textureView.setSurfaceTextureListener(ic_camera.getBotLeftCam().textureListener);
        }
    }
    ...
    private void manageBotmRightCam() {
        ...
        if (mBotmRightCam_textureView.isAvailable()) {
            ...
            mBotmRightCam_textureView.setSurfaceTextureListener(ic_camera.getBotRightCam().textureListener);
        }
    }
